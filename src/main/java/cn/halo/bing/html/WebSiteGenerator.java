package cn.halo.bing.html;

import cn.halo.bing.BingFileUtils;
import cn.halo.bing.Images;
...
public class WebSiteGenerator {
    ...
    public String replaceHead(String html, Images images, String month) {
        html = html.replace(HtmlConstant.Head.HEAD_IMG_URL, images.getSimpleUrl());
    ...
    public String replaceImgList(String html, List<Images> bingImages) {
        ...
        for (Images bingImage : bingImages) {
            imgList.append(HtmlConstant.ImgCard.getImgCard(bingImage));
        }
